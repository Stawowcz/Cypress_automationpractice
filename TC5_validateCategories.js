describe('womenSide', function() {
    ...
    // it("subcategoriseImagecheck", function() {
    //     cy.get(".subcategory-image").should('have.css', 'div.subcategory-image')
    // })
    // it("should display a image in element div with class image", () => {
    //     cy.get('div[class="subcategory-image"]').find("img").should('be.visible');
